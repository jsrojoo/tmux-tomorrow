...
set-window-option -g window-status-format '#[fg=#6699cc,bg=colour235] #I #[fg=#999999,bg=#2d2d2d] #W#{?window_zoomed_flag,*Z,} #[default]'

# make foreground window look like bold yellow foreground tab
# set-window-option -g window-status-current-attr none
set-window-option -g window-status-current-format '#[fg=#f99157,bg=#2d2d2d] #I #[fg=#cccccc,bg=#393939] #W#{?window_zoomed_flag,*Z,} #[default]'
